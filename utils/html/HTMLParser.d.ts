...
declare namespace zetaret.node.utils.html {
	...
	export interface HTMLParser {
		...
		parseFromFile(file: string, dir?: string | boolean): HTMLParser
		parseFromString(str: string): HTMLParser
		...
		attrToObject(aa: Array<object>, el: object, cursor?: number): HTMLParser
	}
